...
:header(GamePacketType::CONNECTION_ACK, SERVER_ID), client_id(new_client_id) {}

EntityCreatePacket::EntityCreatePacket(
    Entity _entity,
    EntityHandle entity_handle)
:header(GamePacketType::ENTITY_CREATE, SERVER_ID), entity(_entity), handle(entity_handle) {}

PhysicsSyncPacket::PhysicsSyncPacket(EntityHandle _entity, Physics physics)
:header(GamePacketType::PHYSICS_SYNC, SERVER_ID), entity(_entity), physics_state(physics) {}

PlayerDamagePacket::PlayerDamagePacket(ClientId _player)
:header(GamePacketType::PLAYER_DAMAGE, SERVER_ID), player(_player) {}
...
:header(GamePacketType::PLAYER_SPAWN, INCOMPLETE_ID), coords(_coords) {}

ControlUpdatePacket::ControlUpdatePacket(PlayerControlState _state)
:header(GamePacketType::CONTROL_UPDATE, INCOMPLETE_ID), state(_state) {}
